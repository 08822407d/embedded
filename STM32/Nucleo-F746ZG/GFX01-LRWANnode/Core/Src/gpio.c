...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(LCD_SPI_DCX_GPIO_Port, LCD_SPI_DCX_Pin, GPIO_PIN_SET);
  ...
  /*Configure GPIO pin : LCD_SPI_DCX_Pin */
  GPIO_InitStruct.Pin = LCD_SPI_DCX_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_HIGH;
  HAL_GPIO_Init(LCD_SPI_DCX_GPIO_Port, &GPIO_InitStruct);
