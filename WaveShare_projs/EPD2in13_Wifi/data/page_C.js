	...
	if( isLvl ) {
		...
		for ( var j = 0; j < dH; j++ ){
			...
			for ( var i = 0; i < dW; i++ ) {
				...
				if ( i == 0 ) {
					errArr[bInd][i + 0] = addVal(errArr[bInd][i + 0], r, g, b, 7.0);
					...
					errArr[bInd][i - 0] = addVal(errArr[bInd][i - 0], r, g, b, 9.0);
				} else {
					errArr[bInd][i - 1] = addVal(errArr[bInd][i - 1], r, g, b, 3.0);
					errArr[bInd][i - 0] = addVal(errArr[bInd][i - 0], r, g, b, 5.0);
